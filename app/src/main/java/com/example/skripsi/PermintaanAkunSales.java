...
public class PermintaanAkunSales extends AppCompatActivity {
    @Nullable
...
//    ProgressBar progressDaftarAkun;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Mananage Permintaan Akun Sales");
        ...
        myAdapter = new PermintaanAkunAdapter(list, new PermintaanAkunAdapter.IOnItemClickListener(){
            ...
            public void onItemPermintaanAkunAdapterClickListener(boolean activate, ListPermintaanAkun listPermintaanAkun) {
                ...
                if(activate){
                    Toast.makeText(PermintaanAkunSales.this, "Permintaan akun telah diproses. . .",Toast.LENGTH_SHORT).show();
                    dbRef2.child(listPermintaanAkun.getuId()).setValue(listPermintaanAkun);
                    dbDel.removeValue();
                    recreate();
                } else {
                    Toast.makeText(PermintaanAkunSales.this,"Permintaan akun telah dihapus. . .", Toast.LENGTH_SHORT).show();
                    dbDel.removeValue();
                    recreate();
                }
            }
        ...
        Query query = dbRef.orderByChild("role").equalTo("Sales");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.home:
                startActivity(new Intent(PermintaanAkunSales.this, PermintaanAkun.class));
                break;
            case R.id.action_logout:
                FirebaseAuth.getInstance().signOut();
                startActivity(new Intent(PermintaanAkunSales.this, LoginActivity.class));
                finish();
                break;
            case R.id.manage_teknisi:
                startActivity(new Intent(PermintaanAkunSales.this, PermintaanAkunTeknisi.class));
                break;
            case R.id.manage_atasan:
                startActivity(new Intent(PermintaanAkunSales.this, PermintaanAkunAtasan.class));
                break;
        }
