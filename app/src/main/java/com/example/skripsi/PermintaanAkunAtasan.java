...
public class PermintaanAkunAtasan extends AppCompatActivity {
    @Nullable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Mananage Permintaan Akun Atasan");
        //setup recyclerview
        ...
        myAdapter = new PermintaanAkunAdapter(list, new PermintaanAkunAdapter.IOnItemClickListener(){
            ...
            public void onItemPermintaanAkunAdapterClickListener(boolean activate, ListPermintaanAkun listPermintaanAkun) {
                ...
                if(activate){
                    Toast.makeText(PermintaanAkunAtasan.this, "Permintaan akun telah diproses. . .",Toast.LENGTH_SHORT).show();
                    dbRef2.child(listPermintaanAkun.getuId()).setValue(listPermintaanAkun);
                    dbDel.removeValue();
                    recreate();
                } else {
                    Toast.makeText(PermintaanAkunAtasan.this,"Permintaan akun telah dihapus. . .", Toast.LENGTH_SHORT).show();
                    dbDel.removeValue();
                    recreate();
                }
            }
        ...
        Query query = dbRef.orderByChild("role").equalTo("Atasan");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.home:
                startActivity(new Intent(PermintaanAkunAtasan.this, PermintaanAkun.class));
                break;
            case R.id.action_logout:
                FirebaseAuth.getInstance().signOut();
                startActivity(new Intent(PermintaanAkunAtasan.this, LoginActivity.class));
                finish();
                break;
            case R.id.manage_sales:
                    startActivity(new Intent(PermintaanAkunAtasan.this, PermintaanAkunSales.class));
                break;
            case R.id.manage_teknisi:
                    startActivity(new Intent(PermintaanAkunAtasan.this, PermintaanAkunTeknisi.class));
                break;
        }
