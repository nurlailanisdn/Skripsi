...
public class SalesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        myAdapter = new ListOnlineAdapter(SalesActivity.this,list);
    ...
    private void getCurrentLocation() {
        if (checkPermissions()) {
            if (isLocationEnabled()) {
                ...
                Toast.makeText(SalesActivity.this, "Please enable your GPS", Toast.LENGTH_LONG).show();
...
//                                onlineStatus.onDisconnect().removeValue();//delete child from listOnline
                            ...
                            String noTelp = listOnline.getNoTelp();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.input_data_pelanggan:
                startActivity(new Intent(SalesActivity.this, InputDataPelanggan.class));
                break;
            ...
            case R.id.edit_profil:
                startActivity(new Intent(SalesActivity.this, EditProfil.class));
                break;
        }
